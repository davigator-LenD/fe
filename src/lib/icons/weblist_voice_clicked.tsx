...
export const SvgWebListVoiceClicked = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" fill="none" {...props}>
        ...
        <defs>
            ...
            >
                ...
                <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_235_786" />
                <feBlend in="SourceGraphic" in2="effect1_backgroundBlur_235_786" result="shape" />
            </filter>
        </defs>
    </svg>
)
