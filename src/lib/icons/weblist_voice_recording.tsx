...
export const SvgWebListVoiceRecording = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" fill="none" {...props}>
        <g filter="url(#a)">
            <rect width="54.695" height="54.695" fill="#EBFE83" rx="27.347" />
        </g>
        <path
            stroke="#121212"
        ...
        <defs>
            ...
            >
                ...
                <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_235_787" />
                <feBlend in="SourceGraphic" in2="effect1_backgroundBlur_235_787" result="shape" />
            </filter>
        </defs>
    </svg>
)
